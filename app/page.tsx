...
export default function Home() {
  const medicalEquipment = [
    ...
    "Walker Folding (With wheels/Without wheels)",
    "Wheel Chair",
    "Pulse Oximeter",
    "Suction Machine",
    "Oxygen Concentrator",
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-[#db4637]/20 hover:border-[#db4637]/40 transition-colors group">
              ...
              <CardContent>
                ...
                <div className="space-y-3 items-center gap-4 mb-4">
            ...
            <Card className="border-2 border-[#453066]/20 hover:border-[#453066]/40 transition-colors group">
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-600 mb-4">
                 <strong>+ {medicalEquipment.length - 8} more medical equipment items available</strong> 
                </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-gray-900">Dignity In Action</h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            To build a compassionate society where no one suffers alone — ensuring dignity, care, and support through free healthcare and end-of-life assistance for all.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600">Near Metro Pillar Number 75, in front of Devi Nagar, New Sanganer Road, Jaipur, Rajasthan.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-gradient-to-r from-[#453066] to-[#3f4787] rounded-full flex items-center justify-center mb-4">
